...
from src.claude_code_relayx.models import MessagesRequest, Message, Tool
from src.claude_code_relayx.backends.openai_compatible.service import (
    call_openai_compatible_chat, count_openai_tokens
)
from src.claude_code_relayx.backends.openai_compatible.translator import (
...
class TestOpenAICompatibleService:
    ...
    @patch('src.claude_code_relayx.backends.openai_compatible.service.get_openai_compatible_client')
    @patch('src.claude_code_relayx.backends.openai_compatible.service.get_openai_compatible_model')
    ...
    def test_token_counting_service(self):
        ...
        from src.claude_code_relayx.models import TokenCountRequest
